...
class Bena_Media_Helpers {
    ...
    public function bena_load_textdomain(): void {
        $text_domain = 'bena-media-helpers';
        $locale = apply_filters( 'plugin_locale', get_locale(), $text_domain );
        $loco_file = WP_PLUGIN_DIR . '/' . plugin_basename( dirname( __FILE__ ) ) . '/languages/' . $text_domain . '-' . $locale . '.l10n.php';
        if ( is_readable( $loco_file ) ) {
            load_textdomain( $text_domain, $loco_file );
        } else {
    ...
    public function bena_render_settings_page(): void {
        ...
        <div class="donate-popup" id="donatePopup">
            <div class="donate-content">
                <span class="close-donate" id="closeDonate">&times;</span>
                <h3><?php esc_html_e( 'Thank you for your Donate!', 'bena-media-helpers' ); ?></h3>
                <p><?php esc_html_e( 'If this website is helpful, please consider donating to help me maintain and develop the project.', 'bena-media-helpers' ); ?></p>
                <div class="donate-methods">
                    <div class="donate-method">
                        <div class="donate-title"><?php esc_html_e( 'Techcombank Bank', 'bena-media-helpers' ); ?></div>
                        <div class="donate-info">
                            <div class="donate-account">
                                <span><?php esc_html_e( 'Account No:', 'bena-media-helpers' ); ?></span>
                                <span class="copy-text" data-text="7679696999">7679696999 <i class="far fa-copy"></i></span>
                            </div>
                            <div class="donate-account">
                                <span><?php esc_html_e( 'Account Name:', 'bena-media-helpers' ); ?></span>
                                <span class="copy-text" data-text="VU NGOC TUAN">VU NGOC TUAN <i class="far fa-copy"></i></span>
                            </div>
                            <!--
                            <div class="donate-account">
                                <span><?php esc_html_e( 'Description:', 'bena-media-helpers' ); ?></span>
                                <span class="copy-text" data-text="UNG HO ADD BACKGROUND">CAFE-PluginBenaMediaHelpers<i class="far fa-copy"></i></span>
                            </div>
                            -->
                        </div>
                    </div>
                    <div class="donate-method">
                        <div class="donate-qr">
                            <img src="https://qr.sepay.vn/img?bank=Techcombank&acc=7679696999&template=&amount=&des=PluginBenaMediaHelpers" alt="QR Code">
                        </div>
                        <div style="text-align: center; margin-top: 15px;">
                            <a href="https://paypal.me/shareforall" target="_blank" class="paypal-donate-btn">
                                <i class="fab fa-paypal"></i> <?php esc_html_e( 'Donate with PayPal', 'bena-media-helpers' ); ?>
                            </a>
                        </div>
                    </div>
                </div>
    ...
    public function bena_admin_styles(): void {
        ...
        <style>
            ...
            .donate-info .donate-account:last-of-type {
                margin-bottom: 0;
            }
            
            .donate-account > span:first-child {
                color: #bbb;
                white-space: nowrap;
            }
            
            .donate-account .copy-text {
                display: flex;
                align-items: center;
                gap: 5px;
                white-space: nowrap;
            ...
            .paypal-donate-btn {
                ...
                align-items: center;
                justify-content: center;
                background: linear-gradient(135deg, #009cde 0%, #0070ba 100%); /* PayPal blue gradient */
                color: white;
                padding: 12px 25px; /* Slightly more padding */
                border-radius: 30px; /* Slightly more rounded */
                text-decoration: none;
                font-weight: 600; /* Slightly less bold, more modern */
                font-size: 17px; /* Slightly larger font */
                transition: all 0.3s ease; /* Transition all properties */
                box-shadow: 0 6px 15px rgba(0, 112, 186, 0.4); /* Softer, more spread shadow */
                border: 1px solid rgba(255, 255, 255, 0.3); /* Subtle white border */
                cursor: pointer;
                letter-spacing: 0.5px; /* A little spacing for readability */
            }

            .paypal-donate-btn:hover {
                background: linear-gradient(135deg, #0070ba 0%, #005ea6 100%); /* Darker gradient on hover */
                transform: translateY(-3px) scale(1.02); /* More pronounced lift and slight scale */
                box-shadow: 0 8px 20px rgba(0, 112, 186, 0.5); /* Stronger shadow on hover */
                border-color: rgba(255, 255, 255, 0.5); /* More visible border on hover */
            }

            .paypal-donate-btn i {
                margin-right: 10px; /* Slightly more space for icon */
    ...
    public function bena_enqueue_assets( string $bena_hook ): void {
        ...
        wp_localize_script(
            ...
            [
                ...
                'i18n' => [
                    'copied' => esc_html__( 'Copied!', 'bena-media-helpers' ),
        ...
        document.addEventListener('DOMContentLoaded', function() {
          ...
          copyTexts.forEach(copyText => {
            copyText.addEventListener('click', function() {
              ...
              // Sử dụng Font Awesome 5 Free cho icon check
              this.innerHTML = benaMediaHelpers.i18n.copied + ' ' + benaMediaHelpers.i18n.checkIcon; 
              
              // Đặt lại nội dung sau 2 giây
              setTimeout(() => {
          ...
          if (donateButton && donatePopup && closeDonate) {
              // Show popup
        ...
        ";
        wp_add_inline_script( $bena_script_handle, $bena_donate_js );
